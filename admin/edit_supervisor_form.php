       ...
       <a href="supervisors.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Supervisor</a>
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<!--
									...
									-->	
									<?php
									$query = mysqli_query($conn,"select * from supervisor where supervisor_id = '$get_id' ")or die(mysqli_error());
									...
									?>
                                          ...
                                          <div class="controls">
											...
											<?php
											$query_supervisor = mysqli_query($conn,"select * from supervisor join  department")or die(mysqli_error());
											$row_supervisor = mysqli_fetch_array($query_supervisor);
											
											?>
											
                                             	<option value="<?php echo $row_supervisor['department_id']; ?>">
												<?php echo $row_supervisor['department_name']; ?>
												</option>
											<?php
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								$query = mysqli_query($conn,"select * from supervisor where firstname = '$firstname' and lastname = '$lastname' ")or die(mysqli_error());
								...
								mysqli_query($conn,"update supervisor set firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id' where supervisor_id = '$get_id' ")or die(mysqli_error());	
								
								?>
								<script>
							 	window.location = "supervisors.php"; 
								</script>
								<?php   }} ?>
