...
<?php include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('term_year_sidebar.php'); ?>
				<div class="span3" id="adduser">
				<?php include('add_term_year.php'); ?>		   			
				</div>
                <div class="span6" id="">
                     <div class="row-fluid">
                        <!-- block -->
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Term List</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_sy.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($conn,"select * from term_year")or die(mysqli_error());
