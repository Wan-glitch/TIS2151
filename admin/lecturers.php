                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a data-toggle="modal" href="#lecturer_delete" id="delete"  class="btn btn-danger" name=""><i class="icon-trash icon-large"></i></a>
                                    ...
                                    $id = $row['lecturer_id'];
                                    $lecturer_stat = $row['lecturer_stat'];
                                        ?>
									<tr>
										<td width="30">
									...
									<td width="50"><a href="edit_lecturer.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i></a></td>
									...
									<?php }else{ ?>
									<td width="120"><a href="edit_lecturer.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-check"></i> Activated</a></td>				
									<?php } ?>
                                </tr>
                            <?php } ?>
