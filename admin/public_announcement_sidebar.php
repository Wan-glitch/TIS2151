<div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li>
                            <a href="admin_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i> Admin</a>
                        </li>
						<li>
						...
						<li  class="active">
                            <a href="public_announcement.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Public Announcement</a>
                        </li>
						<li>
