   <div class="row-fluid">
									...
									-->	
                                          ...
                                          <div class="controls">
                                            <select name="faculty"  class="" required>
                                             	<option></option>
											<?php
											$query = mysqli_query($conn,"select * from faculty order by faculty_name");
					    ...
					    <?php
                            if (isset($_POST['save'])) {
                                ...
                                mysqli_query($conn,"insert into lecturer (firstname,lastname,location,faculty_id)
								values ('$firstname','$lastname','uploads/NO-IMAGE-AVAILABLE.jpg','$faculty_id')         
								") or die(mysqli_error()); ?>
								<script>
