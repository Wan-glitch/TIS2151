					...
					<div class="modal-body">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            ...
                                            <select name="term_year"  class="">
                                            <option></option>
											<?php
											$query1 = mysqli_query($conn,"select * from lecturer_class where class_id ='$class_id' and term_year != '$term_year'")or die(mysqli_error());
											while($row = mysqli_fetch_array($query1)){
											
											?>
											<option><?php echo $row['term_year']; ?></option>
											<input type="hidden" name="lecturer_class_id" value="<?php echo $row['lecturer_class_id']; ?>">
											<?php } ?>
                                            </select>
                                          </div>
                                        </div>
										...
										<div class="control-group">
										  ...
										  <p>Share To:</p>
											...
											<label>To:</label>
                                          <div class="controls">
                                            <select name="lecturer_id1"  class="" required>
                                             	<option></option>
											<?php
											$query = mysqli_query($conn,"select * from lecturer order by firstname");
											while($row = mysqli_fetch_array($query)){
											
											?>
											
											<option value="<?php echo $row['lecturer_id']; ?>"><?php echo $row['firstname']; ?> <?php echo $row['lastname']; ?> </option>
